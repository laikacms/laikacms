...
import { backIcon, loginPageStyles, passkeyIcon } from './styles.js';
...
export interface EnhancedLoginPageOptions {
  ...
  /** Custom logo HTML or URL (defaults to the built-in logo) */
  customLogo?: string;
...
export { backIcon, defaultLogo, loginPageStyles, passkeyIcon } from './styles.js';
