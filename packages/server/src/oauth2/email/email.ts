 ...
 * @example
 * ```typescript
 * import { resetPassword } from '@laikacms/server/oauth2';
 * import { hashPassword } from '@laikacms/server/oauth2';
 *
