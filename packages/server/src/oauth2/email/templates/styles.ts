/**
 * Email design system constants.
 *
 * Inherited from upstream Decap CMS's UI library so transactional emails match
 * the hosted login pages. Kept in step with `../../templates/styles.ts`, not
 * with upstream.
 */
...
// ============================================================================
// Default email logo -- still the upstream Decap CMS wordmark. See the note on
// `defaultLogo` in ../../templates/styles.ts.
// ============================================================================

export const defaultLogoSvg =
  `<svg width="300" height="81" viewBox="0 0 335 90" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M30.73 0.149188L0 2.94919L3.67 43.1592L23.7 41.3292L21.71 19.4692L32.42 18.4892C43.03 17.5192 51.56 26.0192 52.71 38.6792L72.38 36.8892C70.34 14.7192 51.64 -1.75081 30.73 0.149188Z" fill="${colors.brandPink}"/>
  <path d="M73.61 49.5091C73.61 62.2291 65.88 71.4591 55.24 71.4591H44.49V49.4691H24.38V89.8891H55.24C76.26 89.8891 93.36 71.7791 93.36 49.5091C93.36 49.4991 93.36 49.4891 93.36 49.4691H73.61C73.61 49.4691 73.61 49.4891 73.61 49.5091Z" fill="${colors.brandPink}"/>
 ...
 */
export const defaultLogoSvgSmall =
