...
export const permissionDescriptions: Record<Permission, string> = {
  [Permission.ManageSettings]:
    'Allows users to modify and manage system or application settings, including configurations that affect the entire platform.',
  [Permission.ManageUsers]:
    'Grants the ability to manage user accounts, including creating, editing, and deleting users, as well as assigning roles and permissions.',
  ...
  [Permission.PublishDocument]:
    'Enables users to publish documents, making them publicly available or accessible to others.',
  [Permission.DeleteDocument]: 'Provides the ability to permanently delete documents from the system.',
  [Permission.ViewDocument]:
    'Grants permission to view documents, but without the ability to edit, publish, or delete them.',

  // Collection Permissions
  [Permission.ManageCollections]:
    'Allows users to create, edit, or delete collections of documents, as well as configure how collections are organized.',
  [Permission.ViewCollection]:
    'Grants read-only access to view collections of documents, but without the ability to modify them.',
};
