...
const schemas: Record<string, OpenApiSchema> = {
  ...
  DocumentCollectionAttributes: {
    ...
    properties: {
      ...
      draftDirectory: { type: 'string', deprecated: true, description: 'Use unpublishedStatuses instead.' },
      archiveDirectory: { type: 'string', deprecated: true, description: 'Use unpublishedStatuses instead.' },
      trashDirectory: { type: 'string', deprecated: true, description: 'Use unpublishedStatuses instead.' },
    },
    required: ['type'],
  },
