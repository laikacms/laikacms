...
const api = buildJsonApi({ repo: myDocumentsRepo, authorize: allowAll });
```
...
const api = buildJsonApi({ repo: myDocumentsRepo, authorize: myPolicy });
