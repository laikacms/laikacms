...
export const IconControl: React.FC<IconControlProps> = props => {
  ...
  return (
    ...
    >
      ...
      >
        {value && allIcons[value] && React.createElement(allIcons[value as keyof typeof allIcons], { width: 24, height: 24, style: { margin: 8 } })}
        <button
          type="button"
          ...
          >
            {filteredIcons.map((iconName) => {
              ...
              return (
                ...
                >
                  {allIcons[iconName] && React.createElement(allIcons[iconName as keyof typeof allIcons], { width: 24, height: 24, color: iconName === props.value ? colors.textLight : colors.text })}
                </div>
              )
            })}
