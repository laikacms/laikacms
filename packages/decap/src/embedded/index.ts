 ...
 * options object. Not compatible with edge runtimes — use `decapApi` directly
 * from `@laikacms/decap/decap-api` for Cloudflare Workers / Deno Deploy.
 */
...
import type { DecapApi, User } from '../decap-api/index.js';
