...
| [`apps/starter-hono-bun`](../apps/starter-hono-bun/)                   | Hono on **Bun** runtime — `Bun.serve({ fetch: app.fetch })`, no `@hono/node-server`                                      | FileSystem                        | Decap via `decapAdminHtml()`                              | ✅ Working                                                       |
