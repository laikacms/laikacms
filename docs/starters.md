...
| [`apps/starter-platformatic-blog`](../apps/starter-platformatic-blog/) | **Platformatic Service 2** (config-driven Fastify) — same raw-stream bridge, `platformatic.service.json` + tsx dual mode | FileSystem                        | Decap via `decapAdminHtml()`                              | ✅ Working                                                       |
