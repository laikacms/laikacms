...
| [`apps/starter-couchdb-blog`](../apps/starter-couchdb-blog/)           | Apache CouchDB — first-class `_rev` OCC, Mango selectors, `_bulk_docs` multi-delete in two round-trips                   | **CouchDB** (`@laikacms/couchdb`) | Decap via `decapAdminHtml()`                              | ✅ Working                                                       |
