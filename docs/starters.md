...
| [`apps/starter-pinata-blog`](../apps/starter-pinata-blog/)             | Pinata IPFS — **first content-addressed backend**: copy-on-write updates, mutable name-index over immutable CIDs         | **IPFS** (`@laikacms/pinata`)     | Decap via `decapAdminHtml()`                              | ✅ Working                                                       |
