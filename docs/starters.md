...
| [`apps/starter-workers-d1`](../apps/starter-workers-d1/)               | Cloudflare Workers + Hono + **D1** (SQLite) via `DrizzleStorageRepository` + `createCustomLaika`                         | **D1 (SQL)**                      | Decap via `decapAdminHtml()`                              | ✅ Working                                                       |
