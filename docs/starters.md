...
| [`apps/starter-etcd-blog`](../apps/starter-etcd-blog/)                 | etcd (Kubernetes backing store) — base64 wire encoding, prefix range scans, Txn CAS atomic writes                        | **etcd** (`@laikacms/etcd`)       | Decap via `decapAdminHtml()`                              | ✅ Working                                                       |
