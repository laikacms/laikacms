...
| [`apps/starter-influxdb-blog`](../apps/starter-influxdb-blog/)         | Hono — time-series database as CMS; line protocol writes, Flux DSL reads, annotated CSV, nanosecond revisionId           | **InfluxDB v2**                   | Decap via `decapAdminHtml()`                              | ✅ Working                                                       |
