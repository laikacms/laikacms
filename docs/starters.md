...
| [`apps/starter-hexo-blog`](../apps/starter-hexo-blog/)                 | Hexo 8 SSG + LaikaCMS middleware (ESM `.mjs` scripts, `source/_posts/` as content dir)                                   | FileSystem                        | Decap via `decapAdminHtml()`                              | ✅ Working                                                       |
