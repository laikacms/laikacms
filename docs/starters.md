...
| [`apps/starter-gist-blog`](../apps/starter-gist-blog/)                 | GitHub Gist — atomic multi-file PATCH, `/__` filename encoding, single-gist scope with git history                       | **Gist** (`@laikacms/gist`)       | Decap via `decapAdminHtml()`                              | ✅ Working                                                       |
