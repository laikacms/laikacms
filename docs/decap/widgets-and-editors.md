...
> [Quickstart: Node.js](../getting-started/nodejs) and [admin-shell.md](./admin-shell)) — the root
> export has no default export; `DecapCmsApp` is the classic `CMS`-shaped object (`registerWidget`,
