...
const ADMIN_HTML = decapAdminHtml({ decapConfig, title: 'Admin · LaikaCMS Trello starter' });
...
<html lang="en">
<head><meta charset="utf-8"><title>My Blog · Trello</title></head>
<body>
  <h1>My Blog</h1>
  <p style="color:#888">Backed by Trello — cards hold content, lists are folders</p>
  ${body}
...
serve({ fetch: app.fetch, port: PORT }, info => {
  console.log(`Trello blog running at http://localhost:${info.port}`);
