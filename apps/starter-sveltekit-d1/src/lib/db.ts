 ...
 *
 * Called per-request since the D1 binding (platform.env.DB in SvelteKit)
 * is only available within a Cloudflare request context. createCustomLaika
 * itself is a cheap synchronous factory — no TCP or auth overhead.
 */
