...
// The VitePress docs site, served under /docs/ on the same static origin
// (assembled by `pnpm build:site`, see laika-cloud ADR-0028). Paths appended
// to this must match VitePress cleanUrls (no .md / .html suffix).
