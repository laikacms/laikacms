...
const DOC_LINKS: Array<[string, string, string]> = [
  ['Getting Started', 'Five minutes to your first content API', '/getting-started'],
  ['Architecture', 'How core, adapters and the gateway fit', '/architecture'],
  ['API Reference', 'Every method on the JSON:API surface', '/api-reference'],
  ['Decap Integration', 'Wire up the git-gateway + editor UI', '/decap-integration'],
  ['Deployment', 'Node, Bun, Deno, Workers, the edge', '/deployment'],
  ['Packages', 'The full map of subpath exports', '/packages'],
];
