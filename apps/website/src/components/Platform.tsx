      ...
      <div className="max-w-[1200px] mx-auto px-10 max-[760px]:px-[22px]">
        <div className="max-w-[760px] mx-auto flex flex-col items-center">
          ...
          <p className="mt-[22px] text-[clamp(16px,1.5vw,19px)] text-ink-2 leading-[1.6] max-w-[60ch]">
            Today you can self-install{' '}
            <span className="font-mono">laika-gateway</span>, a multi-tenant Cloudflare Worker that points Decap CMS at
            your own repository. The managed Platform will take that further: one place to provision gateways, manage
            tenants, and connect backends. Same open core underneath, nothing locked away.
          </p>
