...
const ADMIN_HTML = decapAdminHtml({ decapConfig, title: 'Admin · LaikaCMS Sanity starter' });
...
<html lang="en">
<head><meta charset="utf-8"><title>My Blog · Sanity</title></head>
<body>
  <h1>My Blog</h1>
  <p style="color:#888">Backed by Sanity Content Lake — GROQ queries, atomic mutations</p>
  ${body}
...
serve({ fetch: app.fetch, port: PORT }, info => {
  console.log(`Sanity blog running at http://localhost:${info.port}`);
