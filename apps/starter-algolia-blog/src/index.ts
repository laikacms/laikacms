...
const ADMIN_HTML = decapAdminHtml({ decapConfig, title: 'Admin · LaikaCMS Algolia starter' });
...
<html lang="en">
<head><meta charset="utf-8"><title>My Blog · Algolia</title></head>
<body>
  <h1>My Blog</h1>
  <p style="color:#888">Backed by Algolia — search index as storage, single-query listings</p>
  ${body}
...
serve({ fetch: app.fetch, port: PORT }, info => {
  console.log(`Algolia blog running at http://localhost:${info.port}`);
