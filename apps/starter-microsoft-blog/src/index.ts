...
const ADMIN_HTML = decapAdminHtml({ decapConfig, title: 'Admin · LaikaCMS OneDrive starter' });
...
<body>
  <h1>My Blog</h1>
  <p style="color:#888">Backed by Microsoft OneDrive via Graph API</p>
  ${body}
...
serve({ fetch: app.fetch, port: PORT }, info => {
  console.log(`Microsoft OneDrive blog running at http://localhost:${info.port}`);
