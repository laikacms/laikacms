...
const ADMIN_HTML = decapAdminHtml({ decapConfig, title: 'Admin · LaikaCMS Bitbucket starter' });
...
<html lang="en">
<head><meta charset="utf-8"><title>My Blog · Bitbucket</title></head>
<body>
  <h1>My Blog</h1>
  <p style="color:#888">Backed by Bitbucket — every edit is a commit</p>
  ${body}
...
serve({ fetch: app.fetch, port: PORT }, info => {
  console.log(`Bitbucket blog running at http://localhost:${info.port}`);
