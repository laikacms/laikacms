...
const ADMIN_HTML = decapAdminHtml({ decapConfig, title: 'Admin · LaikaCMS Google Drive starter' });
...
<html lang="en">
<head><meta charset="utf-8"><title>My Blog · Google Drive</title></head>
<body>
  <h1>My Blog</h1>
  <p style="color:#888">Backed by Google Drive — real folder hierarchy, path→id cache, no googleapis SDK</p>
  ${body}
...
serve({ fetch: app.fetch, port: PORT }, info => {
  console.log(`Google Drive blog running at http://localhost:${info.port}`);
