...
const ADMIN_HTML = decapAdminHtml({ decapConfig, title: 'Admin · LaikaCMS LDAP starter' });
...
<html lang="en">
<head><meta charset="utf-8"><title>My Blog · LDAP</title></head>
<body>
  <h1>My Blog</h1>
  <p style="color:#888">Backed by LDAP — DN addressing, objectClass schema, RFC 4515 filters, scope-based searches</p>
  ${body}
...
serve({ fetch: app.fetch, port: PORT }, info => {
  console.log(`LDAP blog running at http://localhost:${info.port}`);
