...
/**
 * Module-level singleton. LibSqlDataSource is stateless — every call is an
 * independent fetch() to the Turso HTTP endpoint — so creating one instance
 * at module load is safe and avoids repeated allocations across requests.
 *
 * Required env vars:
