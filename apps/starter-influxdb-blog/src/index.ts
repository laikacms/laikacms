...
const ADMIN_HTML = decapAdminHtml({ decapConfig, title: 'Admin · LaikaCMS InfluxDB starter' });
...
<html lang="en">
<head><meta charset="utf-8"><title>My Blog · InfluxDB</title></head>
<body>
  <h1>My Blog</h1>
  <p style="color:#888">Backed by InfluxDB v2 — time-series database as CMS, line protocol writes, Flux DSL reads</p>
  ${body}
...
serve({ fetch: app.fetch, port: PORT }, info => {
  console.log(`InfluxDB blog running at http://localhost:${info.port}`);
