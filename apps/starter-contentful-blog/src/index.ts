...
const ADMIN_HTML = decapAdminHtml({ decapConfig, title: 'Admin · LaikaCMS Contentful starter' });
...
<html lang="en">
<head><meta charset="utf-8"><title>My Blog · Contentful</title></head>
<body>
  <h1>My Blog</h1>
  <p style="color:#888">Backed by Contentful — structured fields, native OCC</p>
  ${body}
...
serve({ fetch: app.fetch, port: PORT }, info => {
  console.log(`Contentful blog running at http://localhost:${info.port}`);
