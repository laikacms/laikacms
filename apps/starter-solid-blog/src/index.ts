...
const ADMIN_HTML = decapAdminHtml({ decapConfig, title: 'Admin · LaikaCMS Solid Pod starter' });
...
<html lang="en">
<head><meta charset="utf-8"><title>My Blog · Solid Pod</title></head>
<body>
  <h1>My Blog</h1>
  <p style="color:#888">Backed by a Solid Pod — decentralised, URI-addressed, RDF/Turtle listings</p>
  ${body}
...
serve({ fetch: app.fetch, port: PORT }, info => {
  console.log(`Solid Pod blog running at http://localhost:${info.port}`);
